...
% modulation parameters
    duration = 3.5e-12; % 3.5 ps
  %% m = 2942008.263764017999999;			% modulation index, by increasing it, the spectra is broadened, and the pulse is shortened.
...
Kmag = 2^6;   % this factor is proportional to the refinement (interval between points) of the transformed frequency data;
...
Nplot = 20000;    % plotted frequency points, it determines the plotted frequency range, not the refinement. 
